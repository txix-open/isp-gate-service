...
func (r AuthenticationCache) Get(ctx context.Context, token string) (*entity.AppAuthData, error) {
...
func (r AuthenticationCache) Set(ctx context.Context, token string, data entity.AppAuthData) error {
