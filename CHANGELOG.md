### v5.2.5
* добавлено новое поле `enableForceUnescapingUnicode` в конфигурации для декодирования тела запроса из unicode в utf-8 при логирование
* реализована поддержка конвертации тела запроса между форматами unicode и utf-8 для корректного логирования
