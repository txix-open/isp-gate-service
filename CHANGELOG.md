### v5.2.3
* Добавлена настройка дли отключения логирования тела запроса и ответа для запросов с `applicationId`=`0`
* Теперь поле `applicationId` не логируется, если `applicationId`=`0`
### v5.2.1
